"""Currency/Date Formatting module.
...
class FormattingConfig:
    """Knobs the formatting module reads at startup."""
    enabled: bool = True
    timeout_s: float = 5.0
    retries: int = 3
...
class Formatting:
    ...
    ``formatting(...)`` defined at module scope.
    """
...
def formatting(payload: dict[str, Any]) -> dict[str, Any]:
    """Module-level convenience wrapper around the default Formatting instance."""
