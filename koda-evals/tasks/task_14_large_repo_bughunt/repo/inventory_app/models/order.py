"""Order Dataclass + Status Enum module.
...
@dataclass
class OrderConfig:
    """Knobs the order module reads at startup."""
    enabled: bool = True
    timeout_s: float = 5.0
    retries: int = 3
...
def order(payload: dict[str, Any]) -> dict[str, Any]:
    """Module-level convenience wrapper around the default Order instance."""
