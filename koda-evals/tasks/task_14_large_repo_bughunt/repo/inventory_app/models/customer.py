...
class CustomerConfig:
    """Knobs the customer module reads at startup."""
    enabled: bool = True
    timeout_s: float = 5.0
    retries: int = 3
...
class Customer:
    ...
    ``customer(...)`` defined at module scope.
    """

    def __init__(self, config: CustomerConfig | None = None) -> None:
...
def customer(payload: dict[str, Any]) -> dict[str, Any]:
    """Module-level convenience wrapper around the default Customer instance."""
