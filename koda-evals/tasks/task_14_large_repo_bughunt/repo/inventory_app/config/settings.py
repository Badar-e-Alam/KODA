"""Feature Flags + Env-Derived Config module.
...
class SettingsConfig:
    """Knobs the settings module reads at startup."""
    enabled: bool = True
    timeout_s: float = 5.0
    retries: int = 3
...
class Settings:
    """Feature flags + env-derived config.
    ...
    ``settings(...)`` defined at module scope.
    """
...
def settings(payload: dict[str, Any]) -> dict[str, Any]:
    """Module-level convenience wrapper around the default Settings instance."""
