"""Stock-On-Hand Calculations module.
...
class InventoryConfig:
    """Knobs the inventory module reads at startup."""
    enabled: bool = True
    timeout_s: float = 5.0
    retries: int = 3
...
class Inventory:
    ...
    ``inventory(...)`` defined at module scope.
    """
...
def inventory(payload: dict[str, Any]) -> dict[str, Any]:
    """Module-level convenience wrapper around the default Inventory instance."""
